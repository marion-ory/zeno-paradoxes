...
Cela tendrait à prouver que la flèche ne se déplace pas et que le mouvement de la flèche entre le décochage et son arrêt sur la cible est une illusion entraînée par cette succession infinie de temps figés.     
...
Point 3 :      
Idem point 1 avec "indice de doute" à rentrer par l'utilisateur, qui consiste à déterminer combien d'instants auront été nécessaires pour que la flèche soit plantée dans la cible : l'utilisateur construit lui même l'illusion du mouvement en donnant cet "indice du doute". L'indice du doute se reporte (je n'ai pas encore fait mon choix) :

Soit à plusieurs fourchette de différentes largeur, plus le coef de doute est élevé et plus la fourchette est large
Soit aux différents palier du paradoxe de la dichotomie : 50% de la distance, puis 25%, etc.